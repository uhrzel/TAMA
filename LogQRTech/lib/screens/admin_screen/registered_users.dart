...
class _HomePageState extends State<HomePage> {
    ...
    if (fullNameController.text == '') {
      setState(() {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
              'Unsuccessfull Registration! Please type user fullname!',
      ...
      setState(() {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
              'Unsuccessfull Registration! Please Include your Course!',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 18.0),
            ),
            backgroundColor: Colors.red));
      ...
      setState(() {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(
              'Unsuccessfull Registration! Please select a valid picture!',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 18.0),
            ),
            backgroundColor: Colors.red));
      ...
      await RegistrationSQLHelper.createItem(studentId!,
          fullNameController.text, imgString, courseController.text);
      _refreshJournals();
    }
  }
  ...
  void inputDetails(BuildContext context) {
    fullNameController == '';
    qrCodeController == '';
    studentId == ''; // Added student ID controller
    _image == null;
    imgString == '';
    FlutterBeep.beep();
  ...
  Future<void> _updateItem(int id) async {
    await RegistrationSQLHelper.updateItem(id, _titleController.text,
        _descriptionController.text, _coursesController.text);
    _refreshJournals();
  }
